...
router.get('/certifications', verifyToken, adminController.getCertifications)
router.post('/certifications', verifyToken, adminController.createCertification)
router.delete('/certifications/:id', verifyToken, adminController.deleteCertification)
